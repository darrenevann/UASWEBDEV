                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="idBimbingan"
                                        value="<?php echo $row_edit['id_bimbingan']; ?>">

                                    <div class="row mb-3 mt-3">

                                        <div class="row mb-3">
                                            <label for="dosenNIDN" class="col-sm-2 col-form-label">Dosen
                                                Pembimbing</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" name="tglBimbingan"
                                                    value="<?php echo $row_edit['tgl_bimbingan']; ?>">
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="isiBimbingan" class="col-sm-2 col-form-label">Isi
                                                Bimbingan</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="isiBimbingan"
                                                    rows="3"><?php echo $row_edit['isi_bimbingan']; ?></textarea>
                                            </div>
                                        </div>
